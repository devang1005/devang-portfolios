...
export default function Portfolio() {
  return <>
      <SEOHead title="Portfolio" description="Browse my complete photography portfolio featuring portraits, landscapes, editorial work, architecture, and documentary projects." />
        ...
        <div className="max-w-7xl mx-auto text-center space-y-6">
          <motion.div initial={{
            ...
            <p className="text-lg md:text-xl text-muted-foreground font-light tracking-wide max-w-2xl mx-auto">
              A collection AI Projects Designed for Real-World Scale.
            </p>
          </motion.div>
        </div>
      </section>
